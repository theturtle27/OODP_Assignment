...
public class RoomServiceOrdersController {
	...
	public void updateRoomServiceOrderStatus(RoomServiceOrdersView roomServiceOrdersView)
	{
		...
		{
			roomServiceOrdersView.displayText("\nNo room service order exists. Create a room service order before updating the status of it!\n\n\n\n\n\n");
			return;
		}
		...
		roomServiceOrder.setRoomServiceOrderStatus(RoomServiceOrderStatus.values()[roomServiceOrderStatus]);
	...
	public void removeRoomServiceOrder(RoomServiceOrdersView roomServiceOrdersView)
	{
		...
		if(roomServiceOrders.size() == 0)
		{
			roomServiceOrdersView.displayText("\nNo room service order can be deleted because no room service order exists!\n\n\n\n\n\n");
			return;
		}
